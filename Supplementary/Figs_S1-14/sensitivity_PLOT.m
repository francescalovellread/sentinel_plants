...
% Version of: Friday 18th February 2022

%% -----------------------------------------------------------------------------------------------
% % This code takes in the output from 'Fig_5_RUN.m' and uses it to plot Fig 5

%% -----------------------------------------------------------------------------------------------
% READ IN DATA

% Provide path to data folder
% cd '/Users/francescalovell-read/Documents/DPhil/Sentinels_paper/Code/new_results/Sensitivity_results/bs=half';
cd '/Users/francescalovell-read/Documents/DPhil/Sentinels_paper/Code/new_results/Fig_5_results';
...
% Redefine NaN utilities as 0 
utSize = size(utility);
for i=1:utSize(1)
    for j=1:utSize(2)
        if utility(i,j)==Inf|utility(i,j)==-Inf
            utility(i,j)= 0;
        end
    end
end
