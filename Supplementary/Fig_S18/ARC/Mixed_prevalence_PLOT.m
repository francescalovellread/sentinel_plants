...
%% -----------------------------------------------------------------------------------------------
% This code takes in the output from 'Mixed_prevalence_RUN.m' and uses it to plot
...
cd '/Users/francescalovell-read/Documents/DPhil/Sentinels_paper/Code/new_results/Mixed_prevalence_results';
...
% Extract matrix of the optimal number of sentinels in the sample
...
levels = 0:0.1:0.9;
[C,h] = contourf(imgaussfilt(optSentProp,1),levels);
